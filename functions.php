...
add_action('init', 'add_image_article');

function add_personalization_about($wp_customize){
...
add_action('customize_register', 'add_personalization_about'); 
